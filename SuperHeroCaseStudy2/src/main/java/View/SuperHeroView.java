...
public class SuperHeroView implements SuperHeroRunner {
    ...
    public void run(SuperHeroController c) {
        ...
        System.out.println(c.getSuperHeroById(1));
        System.out.println(c.getSuperTeamById(2));
        System.out.println(c.getAllSuperTeams());
        System.out.println(c.getAllSuperHeroes());
